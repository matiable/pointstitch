...
Eigen::Isometry3d getFromAprilTagDetectionArray(const my_pcl_tutorial::AprilTagDetectionArray::ConstPtr& tag_detection_array)
{
...
void tagDetection_Callback(const my_pcl_tutorial::AprilTagDetectionArray::ConstPtr& tag_detection_array) {
	Eigen::Isometry3d pose = getFromAprilTagDetectionArray(tag_detection_array);
}
